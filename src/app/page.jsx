  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="px-4 sm:px-6 md:px-12 lg:px-20">
        ...
        <section className="py-16 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-3xl mb-16">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg transition-all transform hover:-translate-y-1">
        ...
        <section className="py-16 mb-16">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-100 p-8 rounded-2xl shadow-lg">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-white border border-indigo-100 p-8 rounded-2xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-3xl mb-16">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100 text-center hover:shadow-lg transition-all transform hover:-translate-y-1">
                ...
                {[
                  ...
                  <div key={index} className={`flex flex-col md:flex-row items-center ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                    <div className="w-full md:w-1/2 mb-6 md:mb-0 md:px-8">
                      <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:border-purple-200 transition-all">
        ...
        <footer className="bg-gray-50 border-t border-gray-200 text-sm sm:text-base">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-12">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-gray-200 pb-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-purple-100 transition">
